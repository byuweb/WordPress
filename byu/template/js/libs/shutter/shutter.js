shutterOnload = function(){shutterReloaded.Init('sh');jQuery('a.shutterset:first').trigger('click');}
/*
Shutter Reloaded
...
// ***************************************************************************
  ...
  Make : function(ln,fs) {
    ...
    if ( shutterLinks[ln].num > 1 ) {
      ...
      prevlink = '<a href="#" onclick="shutterReloaded.Make('+prev+');return false" id="prevpic">'+prevbtn+'</a>'+dv;
      previmg = new Image();
      previmg.src = shutterLinks[prev].link;
    }
	else {
		prevlink = '<span style="visibility:hidden;">'+dv+'<a href="#">'+prevbtn+'</a>'+dv+'</span>';
	}
    
    if ( shutterLinks[ln].num != -1 && shutterLinks[ln].num < (shutterSets[shutterLinks[ln].set].length) ) {
      next = shutterSets[shutterLinks[ln].set][shutterLinks[ln].num];
      nextbtn = this.textBtns ? this.L10n[1] : '<img src="'+this.shImgDir+'next.gif" title="'+this.L10n[1]+'" />';
      nextlink = '<a href="#" onclick="shutterReloaded.Make('+next+');return false" id="nextpic">'+nextbtn+'</a>'+dv;
      nextimg = new Image();
    ...
    NB.innerHTML = prevlink+nextlink+imgNum+' <a href="#" onclick="shutterReloaded.hideShutter();return false" id="closepic">'+closebtn+'</a>';
	...
	if( shutterLinks[ln+1] != null ) {
		preload_image = new Image();
		preload_image.src = shutterLinks[ln+1].link;
	}
  ...
  handleArrowKeys : function(e) {
	...
	if (!e) var e = window.event
		...
		var closelink = document.getElementById('closepic');
